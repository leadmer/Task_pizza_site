...
import { getPreSelectedCountry, getCountrySelectOptions, parsePhoneNumber, generateNationalNumberDigits, migrateParsedInputForNewCountry, e164, getCountryForPartialE164Number, parseInput // Private functions
, get_country_from_possibly_incomplete_international_phone_number, compare_strings, strip_country_calling_code, get_national_significant_number_part, could_number_belong_to_country, trimNumber } from './phoneInputHelpers';
...
describe('phoneInputHelpers', function () {
  ...
  it('should migrate parsed input for new country', function () {
    ...
    migrateParsedInputForNewCountry('', 'RU', 'US', metadata).should.equal(''); // Switching from "International" to a country
    ...
    migrateParsedInputForNewCountry('8005553535', 'RU', 'US', metadata).should.equal('8005553535'); // Switching from "International" to a country.

    migrateParsedInputForNewCountry('+78005553535', null, 'US', metadata).should.equal('+18005553535'); // Switching countries. International number.

    migrateParsedInputForNewCountry('+78005553535', 'RU', 'US', metadata).should.equal('+18005553535'); // Switching countries. International number.
  ...
  it('should get country from possibly incomplete international phone number', function () {
    ...
    expect(get_country_from_possibly_incomplete_international_phone_number('+800', metadata)).to.be.undefined; // Country can be derived.
  ...
  it('should get national significant number part', function () {
    ...
    get_national_significant_number_part('+7800555', null, metadata).should.equal('800555'); // National number.

    get_national_significant_number_part('8', 'RU', metadata).should.equal('');
    get_national_significant_number_part('8800555', 'RU', metadata).should.equal('800555'); // No national (significant) number digits.

    get_national_significant_number_part('+', null, metadata).should.equal('');
    get_national_significant_number_part('+7', null, metadata).should.equal(''); // Always returns a string.
