...
describe('phoneInputHelpers', function () {
  ...
  it('should get national significant number part', function () {
    ...
    (0, _phoneInputHelpers.get_national_significant_number_part)('+7800555', null, _metadataMin["default"]).should.equal('800555'); // National number.

    (0, _phoneInputHelpers.get_national_significant_number_part)('8', 'RU', _metadataMin["default"]).should.equal('');
    (0, _phoneInputHelpers.get_national_significant_number_part)('8800555', 'RU', _metadataMin["default"]).should.equal('800555'); // No national (significant) number digits.

    (0, _phoneInputHelpers.get_national_significant_number_part)('+', null, _metadataMin["default"]).should.equal('');
    (0, _phoneInputHelpers.get_national_significant_number_part)('+7', null, _metadataMin["default"]).should.equal(''); // Always returns a string.

    (0, _phoneInputHelpers.get_national_significant_number_part)('', null, _metadataMin["default"]).should.equal('');
    (0, _phoneInputHelpers.get_national_significant_number_part)('', 'RU', _metadataMin["default"]).should.equal('');
  });
