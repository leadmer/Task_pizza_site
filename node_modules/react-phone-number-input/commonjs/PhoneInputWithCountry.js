...
function (_React$PureComponent) {
  ...
  function PhoneNumberInput_(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onCountryChange", function (newCountry) {
      ...
      var newParsedInput = (0, _phoneInputHelpers.migrateParsedInputForNewCountry)(prevParsedInput, prevCountry, newCountry, metadata, // Convert the phone number to "national" format
      // when the user changes the selected country by hand.
      true);
      var newValue = (0, _phoneInputHelpers.e164)(newParsedInput, newCountry, metadata); // Focus phone number `<input/>` upon country selection.
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (_input) {
      ...
      var _parseInput = (0, _phoneInputHelpers.parseInput)(_input, _this.state.parsedInput, _this.state.country, defaultCountry, _this.state.countries, addInternationalOption, limitMaxLength, metadata),
    ...
    countries = (0, _countries2.getSupportedCountries)(countries, _metadata);
    ...
    _this.state = {
      ...
      country: (0, _phoneInputHelpers.getPreSelectedCountry)(phoneNumber, _defaultCountry, countries || (0, _core.getCountries)(_metadata), _addInternationalOption, _metadata),
      ...
      countrySelectOptions: generateCountrySelectOptions(countries, countryOptionsOrder, _this.props),
  ...
  _createClass(PhoneNumberInput_, [{
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          ...
          countrySelectOptions = _this$state2.countrySelectOptions,
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (props.countries !== state.props.countries || props.labels !== state.props.labels || props.addInternationalOption !== state.props.addInternationalOption) {
        // Re-generate country select options.
        newState.countrySelectOptions = generateCountrySelectOptions((0, _countries2.getSupportedCountries)(props.countries, metadata), (0, _countries2.getSupportedCountryOptions)(props.countryOptionsOrder, metadata), props);
      ...
      if (newDefaultCountry !== prevDefaultCountry && !hasUserSelectedACountry && !value && !newValue) {
        return _objectSpread({}, newState, {
          country: (0, _countries2.isCountrySupportedWithError)(newDefaultCountry, metadata) ? newDefaultCountry : prevDefaultCountry // `value` is `undefined`.
      ...
      // then the country flag would reset on each input.
          ...
          if (phoneNumber) {
            var _countries = (0, _countries2.getSupportedCountries)(props.countries, metadata);
...
function generateParsedInput(value, phoneNumber, _ref) {
  ...
  if (displayInitialValueAsLocalNumber && phoneNumber && phoneNumber.country) {
    return (0, _phoneInputHelpers.generateNationalNumberDigits)(phoneNumber);
  }

  return value;
}

function generateCountrySelectOptions(countries, countryOptionsOrder, _ref2) {
  var labels = _ref2.labels,
      addInternationalOption = _ref2.addInternationalOption,
      metadata = _ref2.metadata;
  return (0, _countries2.sortCountryOptions)((0, _phoneInputHelpers.getCountrySelectOptions)(countries || (0, _core.getCountries)(metadata), labels, addInternationalOption), (0, _countries2.getSupportedCountryOptions)(countryOptionsOrder, metadata));
}
